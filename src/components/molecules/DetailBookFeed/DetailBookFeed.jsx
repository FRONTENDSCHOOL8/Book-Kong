...
function DetailBookFeed() {
  ...
  return (
      <div className="before:content-[''] before:block before:h-3 before:border-t before:border-b before:border-grayscale-100 before:mb-10 before:bg-background-gray mt-3 bg-grayscale-white pb-[56px]" id="feed">
        <div className="flex gap-2 mx-4">
          <h4 className="contents-lg-bold text-grayscale-400">피드</h4>
          <span className="font-bold text-primary-500 contents-lg-bold">{listCount}</span>
        </div>
